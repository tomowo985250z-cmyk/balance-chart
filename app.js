...
function syncOverlayViewBoxes(svg) {
  const sync = () => {
    const viewBox = svg.getAttribute('viewBox') || '0 0 794 1123';
    dotOverlay.setAttribute('viewBox', viewBox);
    document.getElementById('rotationOverlay').setAttribute('viewBox', viewBox);
  };
  sync();
